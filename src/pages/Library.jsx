                ...
                {filteredVideos.map((video) => (
                    ...
                    >
                        <div className="video-thumbnail">
                            {video.thumbnail ? (
                                <img src={video.thumbnail} alt="封面" className="thumb-img" />
                            ) : (
                                <video
                        ...
                        <div className="video-info">
                            ...
                            <div className="video-tags">
                                <span className={`tag ${video.result}`}>{toResultLabel(video.result)}</span>
