...
const createTableTennisDebugResponse = (videoUrl, matchType) => ({
    ...
    physics: {
        ...
        referee_reason: 'Ball landed out of bounds after last valid bounce on side A.',
        ...
        description: 'Detected 19 bounces with auto result FAULT on a table_tennis rally.',
        referee_trace: {
            decision: 'fault',
            rule_chain: 'Ball landed out of bounds after last valid bounce on side A.',
...
const createDebugResponse = (videoUrl, matchType, sportType) => {
    if (sportType === 'table_tennis') {
        return {
            ...
            advice: {
                text: 'Read the spin, stay compact, and control your placement.',
                headline: 'Stay composed',
                focus: 'Recovery',
                next_step: 'Prepare for the next shot.',
                confidence_label: 'medium',
                source: 'heuristic'
            },
            tactics: [
                {
                    name: 'Third Ball Attack',
                    content: 'Use your third ball to set up an aggressive attack after the serve.',
                    score: 0.92,
                    semantic_score: 0.88,
                    bayesian_score: 0.95,
                    context_score: 0.89,
                    ...
                    recommended_action: 'Use your third ball to set up an aggressive attack after the serve.',
                    reason: 'Third Ball Attack fits this rally scenario well with high tactical continuity.',
                    why_this_tactic: 'This tactic capitalizes on early rally opportunities when the opponent is still adjusting.',
                    risk_note: 'Ensure your third ball placement is precise to avoid giving up the initiative.',
                    rank_reason: 'Third Ball Attack ranked highest due to strong tactical fit and continuity.',
                    frontier_hint: 'Continue refining your third ball variations for different serve returns.',
                    evolution_replay: {
                        development_stage: 'refine',
                        policy_mode: 'balanced',
                        replay_score: 0.91,
                        risk_axis: 'medium',
                        training_block: 'Third ball attack variations',
                        why_now: 'Third Ball Attack is relevant as it establishes early rally control.',
                        upgrade_path: [
                            'Practice third ball attacks from different serve return positions.',
                            'Develop both topspin and backspin variations.',
                            'Focus on placement rather than just power.'
                        ]
                    },
            ...
            summary: {
                headline: 'Extended Rally Captured',
                verdict: 'FAULT',
                confidence_label: 'medium',
                key_takeaway: 'Focus on spin recognition and placement in extended rallies.'
            },
            ...
            diagnostics: {
                ...
                motion_feedback: 'Stay compact and watch the spin. | Focus on footwork to get into position early.',
                trajectory_points: 22,
                analysis_quality: 'medium',
                sequence_context: {
                    match_type: matchType,
                    window_size: 2,
                    recent_events: ['Short Control', 'Extended Rally'],
                    ...
                    adaptation_signals: [
                        'Rally duration increasing, need to maintain consistency.',
                        'Spin variation detected, adjust racket angle accordingly.',
                    ],
                    player_adjustment_signals: [
                        'Attack phase shifted to under pressure due to FAULT.',
                        'Pressure load slightly increased, focus on control.',
                    ],
                    ...
                    memory_summary: 'Sequence memory shows an extended spin rally ending in FAULT, focus on control and placement.',
                },
                duel_projection: {
                    primary_plan: 'Third Ball Attack',
                    likely_response: 'Opponent will likely try a quick counter-attack.',
                    ...
                    counter_tactics: [
                        {
                            ...
                            family: 'control',
                            fit_score: 0.85,
                            reason: 'Block Control is effective against quick counter-attacks by slowing down the pace.',
                        },
                    ],
                    exchange_script: [
                        'Focus on control and placement in extended rallies.',
                        'Be ready to change pace and spin variations.',
                        'If opponent attacks, use a controlled block to reset the rally.',
                    ],
                    duel_explanation: 'Third Ball Attack is a good option but carries medium risk in extended spin rallies.',
                    pressure_gate: 'Maintain control and avoid forcing attacks under pressure.',
                },
                policy_update: {
                    ...
                    policy_update_reason: 'Updated policy based on extended spin rally dynamics and FAULT result.',
                    reward_components: {
                        raw_reward: -3.169,
                        trajectory_quality: 0.625,
                        referee_confidence: 0.672,
            ...
            report: {
                headline: 'Extended Spin Rally',
                verdict: 'FAULT',
                top_tactic: 'Third Ball Attack',
                technical_snapshot: {
                    event: 'Extended Rally',
                    pressure_index: 0.803,
                    attack_phase: 'under_pressure',
                ...
                referee_snapshot: {
                    ...
                    recommended_action: 'The FAULT verdict is reliable for training purposes.',
                },
                sequence_snapshot: {
                    memory_summary: 'Sequence memory shows an extended spin rally ending in FAULT, focus on control and placement.',
                    sequence_tags: ['spin-rally', 'control-phase'],
                ...
                tactic_snapshot: {
                    why_this_tactic: 'Third Ball Attack fits the extended rally pattern by creating attacking opportunities.',
                    risk_note: 'Be careful with placement in extended spin rallies - avoid predictable attacks.',
                    rank_reason: 'Third Ball Attack ranked highest due to tactical continuity and adaptability.',
                    frontier_hint: 'Develop more variations of third ball attacks for different serve returns.',
                    evolution_replay: {
                        development_stage: 'refine',
                        policy_mode: 'balanced',
                        replay_score: 0.91,
                ...
                training_plan: {
                    theme: 'Extended Spin Rally Control',
                    priority: 'control-consistency',
                    micro_goal: 'Improve placement consistency and spin recognition in extended rallies.',
                    guardrail: 'Avoid forcing attacks when under pressure in extended rallies.',
                    focus_queue: ['Spin recognition', 'Placement consistency', 'Footwork'],
                    phase_distribution: ['neutral', 'under_pressure'],
                    blocks: [
                        {
                            label: 'Spin Recognition Drills',
                            duration_min: 10,
                            intensity: 'medium',
                            goal: 'Improve ability to read and react to different spin types.',
                        },
                        {
                            label: 'Extended Rally Practice',
                            duration_min: 15,
                            intensity: 'medium',
                            goal: 'Build consistency and control in longer rallies.',
                        },
                    ],
                },
                coach_takeaway: 'Focus on control, placement, and spin recognition in extended rallies.',
            },
        };
    }
    return {
        ...
        report: {
            ...
            tactic_snapshot: {
                why_this_tactic: 'Counter Block converts the opponent\'s pace into a front-court recovery problem.',
    ...
    async uploadVideo(videoFile, options = {}) {
        ...
        try {
            ...
            if (!response.ok) {
                ...
                throw new Error(`Analysis failed (HTTP ${response.status})${reason}`);
            }
